        ...
        <panel-section section-title="users.details.section.administrative">
            <form #administrativeForm="ngForm">
                <form-field label="firstName">
                    <input type="text" [(ngModel)]="details.firstName" name="firstName" required #firstNameInput="ngModel">
                    <form-errors [control]="firstNameInput"></form-errors>
                </form-field>
                <form-field label="lastName">
                    <input type="text" [(ngModel)]="details.lastName" name="lastName" required #lastNameInput="ngModel">
                    <form-errors [control]="lastNameInput"></form-errors>
                </form-field>
                <form-field label="displayName">
                    <input type="text" [(ngModel)]="details.displayName" name="displayName" required #displayNameInput="ngModel">
                    <form-errors [control]="displayNameInput"></form-errors>
                </form-field>
                <form-field label="birthDate">
                    <date-picker [(ngModel)]="details.birthDate" name="birthDate" #birthDateInput="ngModel" minDate="1900-01-01" maxDate="today">
                    </date-picker>
                ...
                <form-field label="email">
                    <input type="email" [(ngModel)]="details.email" name="email" #emailInput="ngModel" [pattern]="emailPattern">
