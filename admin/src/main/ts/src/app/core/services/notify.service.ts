...
($ as any).noty.defaults.theme = 'relax';
($ as any).noty.defaults.timeout = 2500;
($ as any).noty.defaults.progressBar = true;
($ as any).noty.defaults.closeWith = ['button'];
($ as any).noty.defaults.template = `
...
export class NotifyService {
    ...
    public success(content: I18nKey, title?: I18nKey, opts?: any) {
        this.notify(content, title, null, 'success', opts);
    }

    public info(content: I18nKey, title?: I18nKey, opts?: any) {
        this.notify(content, title, null, 'information', opts);
    }

    public error(content: I18nKey, title?: I18nKey, err?, opts?: any) {
