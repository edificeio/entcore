...
describe('GroupDetailsComponent', () => {
    ...
    it('should create the GroupDetailsComponent component', waitForAsync(() => {
    ...
    it(`should call the communicationRulesService.toggleInternalCommunicationRule when clicking on the communication rules switch and confirming the change`, () => {
        ...
        (mockCommunicationRulesService.toggleInternalCommunicationRule as jasmine.Spy).and.returnValue(of({}));
    ...
    it('should call the groupsService.delete when clicking on the delete group button', () => {
        ...
        (mockGroupsService.delete as jasmine.Spy).and.returnValue(of({}));
    ...
    it('should call the groupsService.update when clicking on the update group button', () => {
        ...
        (mockGroupsService.update as jasmine.Spy).and.returnValue(of({}));
