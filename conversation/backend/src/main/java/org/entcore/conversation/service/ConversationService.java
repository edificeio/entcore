...
public interface ConversationService {
	...
	/**
	 * Maximum depth which folders can be listed at (depth 1 meaning root folders only) in one request.
	 * Limited to MAX_FOLDER_DEPTH at best.
	 * Will impact the max number of results as a power of MAX_FOLDER_NUMBER.
	 * 
	 * For example, listing folders with a depth of 2 <=> returning MAX_FOLDER_NUMBER^2 =2500 folders at once in the worst case.
	 */
	public static final int MAX_LISTABLE_DEPTH = 2;
