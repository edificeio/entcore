    ...
    server: {
      ...
      proxy: {
        ...
        '^/(?=auth|appregistry|cas|userbook|directory|communication|portal|session|timeline|workspace|infra)':
          proxyObj,
        '^/conversation/(?=api/|messages/|message|folders/|folder$|folder/trash|trash$|restore$|delete$|move$|move/|count/|toggleUnread|i18n|draft|draft/|conf/public|emptyTrash)':
          proxyObj,
      },
      port: 4200,
      headers,
