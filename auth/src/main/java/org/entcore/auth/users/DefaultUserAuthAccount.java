...
public class DefaultUserAuthAccount implements UserAuthAccount {
	...
	private void setResetCode(final String login, boolean checkFederatedLogin, final String code, final Handler<Boolean> handler) {
		String query =
				"MATCH (n:User) " +
	...
	public void sendResetCode(final HttpServerRequest request, final String login, final SendPasswordDestination dest,boolean checkFederatedLogin ,
		...
		setResetCode(login, checkFederatedLogin, code, new Handler<Boolean>() {
			@Override
	...
	@Override
	public void generateResetCode(HttpServerRequest request, String login, boolean checkFederatedLogin , Handler<Either<String, String>> handler) {
		final String code = StringValidation.generateRandomCode(8);
		setResetCode(login, checkFederatedLogin, code, success -> {
			if (success) {
