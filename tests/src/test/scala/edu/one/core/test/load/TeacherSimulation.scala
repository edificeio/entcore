    ...
    .exec(http("share blog ${newBlogId} to teachers (read)")
      ...
      .pause(1)
		.exec(http("share blog ${newBlogId} to teachers (contrib)")
			.put("""/blog/share/json/${newBlogId}""")
			.bodyPart(StringBodyPart("""groupId""", """${profilGroupTeachersSchoolId}"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|unpublish"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|create"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|delete"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|update"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|submit""")))
		.pause(1)
    .exec(http("share blog ${newBlogId} to teachers (comment)")
      .put("""/blog/share/json/${newBlogId}""")
      .bodyPart(StringBodyPart("""groupId""", """${profilGroupTeachersSchoolId}"""))
      .bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|deleteComment"""))
      .bodyPart(StringBodyPart("""actions""", """edu-one-core-blog-controllers-PostController|comment""")))
    .pause(1)
...
val chain_5 = exec(http("show-list-selected.png")
      ...
      .check(status.is(201), jsonPath("$._id").find.saveAs("document0Id")))
		...
		.exec(http("share document to teachers (read)")
			...
			.bodyPart(StringBodyPart("""groupId""", """${profilGroupTeachersSchoolId}"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-workspace-service-WorkspaceService|getDocument""")))
		.pause(1)
		.exec(http("share document to teachers (comment)")
			.put("""/workspace/share/json/${document0Id}""")
			.bodyPart(StringBodyPart("""groupId""", """${profilGroupTeachersSchoolId}"""))
			.bodyPart(StringBodyPart("""actions""", """edu-one-core-workspace-service-WorkspaceService|commentDocument""")))
		.pause(1)
