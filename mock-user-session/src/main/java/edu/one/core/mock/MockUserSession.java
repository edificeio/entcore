...
public class MockUserSession extends BusModBase implements Handler<Message<JsonObject>> {
	...
	private void doFind(Message<JsonObject> message) {
		...
		String actions = "[{ \"name\" : \"edu.one.core.registry.service.AppRegistryService|listApplications\", \"displayName\" : "
				...
				+ "{ \"name\" : \"edu.one.core.workspace.service.WorkspaceService|addDocument\", \"displayName\" : "
				+ "\"workspace.view\", \"type\" : \"WORKFLOW\"}, "
				+ "{ \"name\" : \"edu.one.core.workspace.service.WorkspaceService|addRackDocument\", \"displayName\" : "
				+ "\"workspace.view\", \"type\" : \"WORKFLOW\"}, "
				+ "{ \"name\" : \"edu.one.core.workspace.service.WorkspaceService|shareDocument\", \"displayName\" : "
				+ "\"workspace.share.document\", \"type\" : \"WORKFLOW\"}, "
				+ "{ \"name\" : \"edu.one.core.workspace.service.WorkspaceService|share\", \"displayName\" : "
				+ "\"workspace.share\", \"type\" : \"WORKFLOW\"}, "
				+ "{ \"name\" : \"edu.one.core.workspace.service.WorkspaceService|view\", \"displayName\" : "
				+ "\"workspace.view\", \"type\" : \"WORKFLOW\"}, "
