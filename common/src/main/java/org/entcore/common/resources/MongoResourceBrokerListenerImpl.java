...
public class MongoResourceBrokerListenerImpl extends AbstractResourceBrokerListener {
    ...
    protected ResourceInfoDTO convertToResourceInfoDTO(JsonObject resource) {
        ...
        try {
            ...
            // Extract dates
            final Date creationDate = parseDate(resource.getLong("created", System.currentTimeMillis()));
            final Date modificationDate = parseDate(resource.getLong("modified", System.currentTimeMillis()));
    ...
    protected Date parseDate(Long timestamp) {
