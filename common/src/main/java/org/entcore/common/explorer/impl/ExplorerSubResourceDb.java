...
public abstract class ExplorerSubResourceDb extends ExplorerSubResource{
    protected final IExplorerDb explorerDb;

    protected ExplorerSubResourceDb(final ExplorerPlugin parent, final IExplorerDb crud) {
        super(parent);
