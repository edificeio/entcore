				...
				if (event.succeeded() && event.result().length > 0) {
					if (fullPath) {
						...
						for (int i = 0; i < files.length; i++) {
							...
							if (Arrays.asList("css","font","fonts","img","template","i18n","portal.html","js","bower.json",".bower.json","LICENSE", "override-img", "override-js", "override-template", "override-css", "README.md").contains(file)) continue;
							t.add(file);
						}
						themes.handle(t);
					}
