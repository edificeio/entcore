...
public class NotificationHelperTest {
    ...
    public void testIsQuietHour_NoPreference_NoUai_NotQuiet() {
        ...
        assertFalse(NotificationHelper.isQuietHour(Instant.now(), null, (String) null));
    }
    ...
    public void testIsQuietHour_NoPreference_WithUai_NotQuiet() {
        ...
        assertFalse(NotificationHelper.isQuietHour(wednesday10h.toInstant(), null, "0750010E"));
    }
    ...
    public void testIsQuietHour_EnabledFalse_NotQuiet() {
        ...
        userPrefQuietHours.setTimezone("Europe/Paris");
        userPrefQuietHours.setSchedule(schedule);
        // enabled stays false (primitive default)
        ZonedDateTime monday10h = dt(2026, 3, 30, 10, 0);
        assertFalse(NotificationHelper.isQuietHour(monday10h.toInstant(), userPrefQuietHours, "0750010E"));
    }
    ...
    public void testIsQuietHour_WithSchedulePreference_UsesSchedule() {
        ...
        userPrefQuietHours.setSchedule(schedule);
        ZonedDateTime monday10h = dt(2026, 3, 30, 10, 0);
        assertTrue(NotificationHelper.isQuietHour(monday10h.toInstant(), userPrefQuietHours, "0750010E"));
    }
    ...
    public void testIsQuietHour_PreferenceTzOverridesUai() {
        ...
        QuietHoursPreference userPrefQuietHours = new QuietHoursPreference();
        userPrefQuietHours.setEnabled(true);
        userPrefQuietHours.setTimezone("Indian/Reunion");
        userPrefQuietHours.setSchedule(schedule);
        ZonedDateTime wednesday10hParis = dt(2026, 4, 1, 10, 0);
        assertFalse(NotificationHelper.isQuietHour(wednesday10hParis.toInstant(), userPrefQuietHours, "9710001A"));
    }

    // --- resolveTimezone priority tests ---

    // --- resolveTimezone(QuietHoursPreference, String) ---
    ...
    public void testResolveTimezone_PreferenceOverridesUai() {
        ...
        QuietHoursPreference userPrefQuietHours = new QuietHoursPreference();
        userPrefQuietHours.setTimezone("Indian/Reunion");
        assertEquals(ZoneId.of("Indian/Reunion"), NotificationHelper.resolveTimezone(userPrefQuietHours, "9710001A"));
    }
    ...
    public void testResolveTimezone_FallsBackToUai_WhenNoTzInPref() {
        ...
        QuietHoursPreference userPrefQuietHours = new QuietHoursPreference();
        assertEquals(ZoneId.of("Indian/Reunion"), NotificationHelper.resolveTimezone(userPrefQuietHours, "9740001A"));
    }
    ...
    public void testResolveTimezone_InvalidTzInPref_FallsBackToUai() {
        ...
        QuietHoursPreference userPrefQuietHours = new QuietHoursPreference();
        userPrefQuietHours.setTimezone("Invalid/Zone");
        assertEquals(ZoneId.of("Europe/Paris"), NotificationHelper.resolveTimezone(userPrefQuietHours, "0750010E"));
    }
}
