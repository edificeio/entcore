...
public class ClassController extends BaseController {
	...
	public void createUser(final HttpServerRequest request) {
		bodyToJson(request, new Handler<JsonObject>() {
			...
			public void handle(JsonObject body) {
				final String classId = request.params().get("classId");
				userService.createInClass(classId, body, null, new Handler<Either<String, JsonObject>>() {
					@Override
	...
	public void findUsers(final HttpServerRequest request) {
		...
		classService.findUsers(classId, types, collectRelative, withFederated, ine, handler);
	}
