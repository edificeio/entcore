...
public interface ShareBrokerListener {
   ...
   */
  @BrokerListener(subject = "share.group.upsert", proxy = true)
  UpsertGroupSharesResponseDTO upsertGroupShares(UpsertGroupSharesRequestDTO request);
   ...
   */
  @BrokerListener(subject = "share.group.remove", proxy = true)
  RemoveGroupSharesResponseDTO upsertGroupShares(RemoveGroupSharesRequestDTO request);
}
