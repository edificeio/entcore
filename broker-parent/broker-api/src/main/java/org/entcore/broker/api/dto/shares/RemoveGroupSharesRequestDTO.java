...
public class RemoveGroupSharesRequestDTO {
  ...
  @JsonCreator
  public RemoveGroupSharesRequestDTO(@JsonProperty("application") String application, @JsonProperty("groupId") String groupId, @JsonProperty("groupExternalId") String groupExternalId, @JsonProperty("resourceId") String resourceId) {
