...
public class DefaultCommunicationServiceTest {
    ...
    //-----------------------------------------------------------------------------------------------------
    // NOTE JCBE 2022-02-01 : #WB-115, the new "broadcast list" feature has made the tests below OBSOLETE.
    // These are more functional than technical tests. They cannot be THAT SIMPLE anymore.
    //-----------------------------------------------------------------------------------------------------
